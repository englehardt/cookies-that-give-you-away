...
from Commands.profile_commands import clear_all_flash
...
class TaskManager:
    ...
    def __init__(self, db_path, browser_params, num_browsers, task_description=None):
        ...
        # If any browser is using flash, clear flash locations
        for prefs in browser_params:
            if not prefs['disable_flash']:
                clear_all_flash()
                break
